...
public class ReportActivity extends ActionBarActivity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sendButton = (Button) findViewById(R.id.gcmButton);
        messageToSend = (TextView) findViewById(R.id.gcmTextSend);
    ...
    private SharedPreferences getGcmPreferences(Context context) {
        ...
        return getSharedPreferences(ReportActivity.class.getSimpleName(),
    ...
    public void onClick(View v) {
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                ...
                try {
                    Bundle data = new Bundle();
                    data.putString("message", "Hello World from phone");
                    data.putString("action", "RESPOND");
                    String id = UUID.randomUUID().toString();
                    gcm.send(SENDER_ID + "@gcm.googleapis.com", id, data);
                    msg = "Sent message";
                } catch (IOException ex) {
