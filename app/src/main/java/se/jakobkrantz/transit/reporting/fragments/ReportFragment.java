package se.jakobkrantz.transit.reporting.fragments;
...
import se.jakobkrantz.transit.reporting.ReportActivity;
import se.jakobkrantz.transit.utils.BundleConstants;
import se.jakobkrantz.transit.utils.GcmConstants;
...
public class ReportFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (checkPlayServices()) {
            ...
            sendButton = (FloatingActionButton) view.findViewById(R.id.gcmButton);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.report_from_station) {
            ...
            final String fromText = fromStation.getText().toString();
            final String toText = toStation.getText().toString();
            final String selectedItemText = disturbanceType.getSelectedItem().toString();
            final String disturbanceText =  disturbanceNote.getText().toString();
            new AsyncTask<Void, Void, String>() {
                @Override
                protected String doInBackground(Void... params) {
                    Bundle args = getArguments();
                    ...
                    if (wasRegToBackendSuccessful()) {
                        ...
                        try {
                            ...
                            dataToSend.putString(GcmConstants.DISTURBANCE_FROM_STATION_NAME, fromText);
                            dataToSend.putString(GcmConstants.DISTURBANCE_TO_STATION_NAME, toText);
                            dataToSend.putString(GcmConstants.DISTURBANCE_APPROX_MINS, Integer.toString(deviationTime));
                            dataToSend.putString(GcmConstants.DISTURBANCE_TYPE, selectedItemText);
                            ...
                            if (!disturbanceText.equals("")) {
                                dataToSend.putString(GcmConstants.DISTURBANCE_NOTE, disturbanceText);
                            }
