...
//    public static String REGIONBUSS = "2";
    ...
    public static final int REGIONBUSS = 1;
    public static final int SKÅNE_EXPRESSEN = 2;
    public static final int STADSBUSS = 4;
    public static final int KRÖSATÅG = 8;
    public static final int PÅGATÅG_EXPRESS = 16;
    public static final int PÅGATÅGEN = 32;
    public static final int TÅGBUSS = 64;
    public static final int ÖRESUNDSTÅG = 128;

    public static final int KOMMERSIELL_TRAFIK = 256;
    public static final int FÄRJEFÖRBINDELSE = 512;
