...
import se.jakobkrantz.transit.database.DatabaseTransitSQLite;
import se.jakobkrantz.transit.database.SimpleJourney;
import se.jakobkrantz.transit.searching.FavouriteListAdapter;
import se.jakobkrantz.transit.searching.FillUIHelper;
import se.jakobkrantz.transit.searching.SearchActivity;
